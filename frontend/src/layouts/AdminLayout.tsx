...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/sandbox", label: "Sandbox DSP" },
    ],
  },
  {
    section: "Finance",
    items: [
      { to: "/admin/royalties", label: "Royalties" },
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside
        style={{
          ...
          borderRight: "0.5px solid rgba(107,26,46,0.35)",
          display: "flex",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(180deg,transparent 0%,#A8385A 40%,#4A1F52 70%,transparent 100%)",
            opacity: 0.5,
          }}
        />
        ...
        <div
          style={{
            ...
            borderBottom: "0.5px solid rgba(107,26,46,0.35)",
          }}
        >
          <div
            style={{
          ...
          >
            AP <span style={{ color: "#A8385A" }}>Studios</span>
          </div>
          <div
            style={{
              fontSize: 11,
        ...
        <div
          style={{
            padding: "18px 24px",
            borderTop: "0.5px solid rgba(107,26,46,0.35)",
          }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div
              style={{
                ...
                height: 36,
                borderRadius: "50%",
                background: "linear-gradient(135deg,#6B1A2E 0%,#4A1F52 100%)",
                display: "flex",
                alignItems: "center",
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              gap: 6,
              background:
                "linear-gradient(135deg,#6B1A2E 0%,#8B2A42 100%)",
              border: "0.5px solid rgba(168,56,90,0.4)",
              borderRadius: 8,
              padding: "10px 18px",
              fontSize: 13,
              fontWeight: 400,
